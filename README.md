...
- [🚀 Швидкий старт](./QUICKSTART.md) - мінімальний набір команд для розгортання
- [🏗️ Архітектура проекту](./ARCHITECTURE.md) - детальний опис архітектури системи
- [🛠️ Розв'язання проблем](./TROUBLESHOOTING.md) - гід по troubleshooting та діагностиці, RDS та ECR
